...
if __name__ == "__main__":
    ...
    while True:
        ...
        # 🧍 Character detection
        char_pos = find_character(screen)
        if char_pos:
            r, c = char_pos
            cv2.rectangle(grid_overlay, (c*TILE_SIZE, r*TILE_SIZE),
                          ((c+1)*TILE_SIZE, (r+1)*TILE_SIZE), (255, 255, 0), 2)

            # ✅ Exit match
            if last_known_exit and (r, c) == last_known_exit:
                print("🚪 Character stepped on EXIT. Closing.")
                break
